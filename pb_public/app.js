...
function Bio() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-evenly" }, /* @__PURE__ */ React.createElement("p", { id: "bio", className: "text-medium text-gray-500 hover:bg-gray-200 w-full" }, bio), /* @__PURE__ */ React.createElement(Form, { title: "Edit Your Bio!", collection: "users", content: bio })));
}
