...
return (
  ...
  <main className="max-w-3xl mx-auto m-8">
...
>>>>>>> r_branch
      ...
      <div className="flex justify-end mt-8">
        <button onClick={() => subDetails()} className="px-3 py-2 bg-gray-700 text-white rounded-full hover:bg-gray-500">
          Add New Subject
        </button>
      </div>
      <div id = 'subjectdetbtn'> </div>
